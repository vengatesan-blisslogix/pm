...
worksheet1.write(0,2, 'Skill Set', format)
worksheet1.write(0,3, 'Years of Experience', format)
worksheet1.write(0,4, 'Billable hour', format)
worksheet1.write(0,5, 'Non-Billable hour', format)
worksheet1.write(0,6, 'Total hour', format)
